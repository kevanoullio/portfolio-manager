...
class AccountAuthenticator:
    def __init__(self, user_account_operation: UserAccountOperation, email_account_operation: EmailAccountOperation) -> None:
        self._user_account_operation = user_account_operation
        self._email_account_operation = email_account_operation
    ...
    def validate_user_credentials(self, provided_username: str, provided_password_hash: bytes) -> bool:
        ...
        user_account_password_hash: bytes | None = self._user_account_operation.get_user_password_by_username(provided_username)
        ...
        if user_account_password_hash is None:
            ...
            if self._verify_password(provided_password_hash, user_account_password_hash):
    ...
    def validate_email_credentials(self, provided_email_address: str, provided_password_hash: bytes) -> bool | None:
        ...
        if email_account_password_hash is None:
            ...
            if self._verify_password(provided_password_hash, email_account_password_hash):
                return True
            else:
                print("Invalid email credentials.")
                return False

    def _verify_password(self, provided_password_hash: bytes, stored_password_hash: bytes) -> bool:
